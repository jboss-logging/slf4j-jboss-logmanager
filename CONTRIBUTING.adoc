...
Want to contribute to the slf4j-jboss-logmanager? We try to make it easy, and all contributions, even the smaller ones,
...
All original contributions to slf4j-jboss-logmanager are licensed under the
...
This project uses https://github.com/jboss-logging/slf4j-jboss-logmanager/issues[GitHub Issues] for filing issues.
...
slf4j-jboss-logmanager has a strictly enforced code style. Code formatting is done by the Eclipse code formatter, using the config files
found in the https://github.com/jboss-logging/logmanager-dev-tools/blob/main/ide-config/src/main/resources/[eclipse-code-formatter.xml]
